...
DESCRIPTION="HalfLife Linux Server (before steam version)"
SRC_URI="${MY_PN}.bin
...
pkg_nofetch() {
	...
	echo
	einfo "And then download hlds_l_3111e_update.tar.gz"
}
