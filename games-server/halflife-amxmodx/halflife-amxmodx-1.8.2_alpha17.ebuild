...
SRC_URI="http://www.amxmodx.org/amxxdrop/1.8/amxmodx-${MY_PV}-base.tar.gz"
...
if use src ; then
	...
	for MOD in $MODS; do
		SRC_URI="${SRC_URI} hl-${MOD}? ( http://www.amxmodx.org/amxxdrop/1.8/amxmodx-${MY_PV}-${MOD}.tar.gz )"
	done
